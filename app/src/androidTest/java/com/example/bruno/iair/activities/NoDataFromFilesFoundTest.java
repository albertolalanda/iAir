...
public class NoDataFromFilesFoundTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void nodataFromFilesFoundTest() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(android.R.id.message), withText("No saved data!"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("No saved data!")));
