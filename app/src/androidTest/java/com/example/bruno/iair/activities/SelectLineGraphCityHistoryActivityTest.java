...
public class SelectLineGraphCityHistoryActivityTest {

    @Rule
    public ActivityTestRule<DashBoardActivity> mActivityTestRule = new ActivityTestRule<>(DashBoardActivity.class);

    @Test
    public void selectLineGraphCityHistoryActivityTest() {
        ...
        ViewInteraction view = onView(
                allOf(withId(R.id.AQILineGraph),
                        childAtPosition(
                                allOf(withId(R.id.LineGraphs),
                                        childAtPosition(
